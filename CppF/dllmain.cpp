...
#define dllmain _declspec(dllexport)
...
bool mainTask::createList()
{
	//W.log("Called mainTask::createList");
	if (result.empty()) { /*W.log("mainTask::createList exit with error: cannot create list - load data from file first");*/ return false; }
